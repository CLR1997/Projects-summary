...
#urrent_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
#csv_path = os.path.join(current_dir, 'benchmarks', 'forecasting', 'data', 'series.csv')
#rrd.data = pd.read_csv(csv_path)
